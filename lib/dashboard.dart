//import 'package:contrasave_1/login.dart'; // Assuming login() leads to profile settings
...
class Dashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text ("Welcome to Contrasave", style: TextStyle(color: Colors.black
        ),),
        elevation: 0,
        ...
        child: Row(
          ...
          children: [
            IconButton(
              ...
              onPressed: () {
                Get.to(MyRepository());
                } // Implement menu dropdown logic later, put repository
            ),
            IconButton(
